...
This utilizes fedmap strategy.And includes datasets from client side which are under `dataset/` and 'all_in_one_dataset/' folders  and a simple BERT + ResNet18 fusion model.
